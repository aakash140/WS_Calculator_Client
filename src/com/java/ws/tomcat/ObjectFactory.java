 ...
 * generated in the com.java.ws.tomcat package. 
...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("http://tomcat.ws.java.com/", "add");
    private final static QName _Sub_QNAME = new QName("http://tomcat.ws.java.com/", "sub");
    private final static QName _SubResponse_QNAME = new QName("http://tomcat.ws.java.com/", "subResponse");
    private final static QName _AddResponse_QNAME = new QName("http://tomcat.ws.java.com/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://tomcat.ws.java.com/", "multiplyResponse");
    private final static QName _Divide_QNAME = new QName("http://tomcat.ws.java.com/", "divide");
    private final static QName _DivideResponse_QNAME = new QName("http://tomcat.ws.java.com/", "divideResponse");
    private final static QName _Multiply_QNAME = new QName("http://tomcat.ws.java.com/", "multiply");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.java.ws.tomcat
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tomcat.ws.java.com/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tomcat.ws.java.com/", name = "sub")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tomcat.ws.java.com/", name = "subResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tomcat.ws.java.com/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tomcat.ws.java.com/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tomcat.ws.java.com/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tomcat.ws.java.com/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tomcat.ws.java.com/", name = "multiply")
