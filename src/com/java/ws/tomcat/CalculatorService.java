 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://tomcat.ws.java.com/", wsdlLocation = "http://localhost:8081/WebService_Tomcat/CalculatorURL?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://tomcat.ws.java.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/WebService_Tomcat/CalculatorURL?wsdl");
    ...
    public CalculatorIfc getCalculatorPort() {
        return super.getPort(new QName("http://tomcat.ws.java.com/", "CalculatorPort"), CalculatorIfc.class);
    }
    ...
    public CalculatorIfc getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tomcat.ws.java.com/", "CalculatorPort"), CalculatorIfc.class, features);
    }
